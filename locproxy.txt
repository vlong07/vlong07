...
def detect_location(proxy):
    ...
    if response.status_code == 200:
        ...
        if data["status"] == "success":
            print(f" \033[1;37m[\033[1;31mvL\033[1;37m] \033[1;37m{proxy} \033[1;31m• \033[1;37m{data['country']}/{data['city']} \033[1;31m• \033[1;32mLIVE")
            open(luu,'a').write(proxy+'\n')
        else:
            print(" \033[1;37m[\033[1;31mvL\033[1;37m] \033[1;31mFailed to detect location for proxy.")
